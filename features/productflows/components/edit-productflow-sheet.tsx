...
export const EditProductflowSheet = () => {
  ...
  const defaultValues = productflowQuery.data
    ? {
        ...
        sourceId: productflowQuery.data.sourceId,
        destinationId: productflowQuery.data.destinationId,
        minThroughput: productflowQuery.data.minThroughput,
        maxThroughput: productflowQuery.data.maxThroughput,
        vehicleTypeId: productflowQuery.data.vehicleTypeId,
        productId: productflowQuery.data.productId,
        timePeriodId: productflowQuery.data.timePeriodId,
        fixed: productflowQuery.data.fixed,
